...
- [Advanced Configuration Example](./Advanced-Configuration-Example.md)
  - [How to implement CUSTOM requirements](./Advanced-Configuration-Example/how-to-implement-custom-requirements.md)
    ...
    - [Operations](./Advanced-Configuration-Example/operations.md)
    - [Example](./Advanced-Configuration-Example/an-example-operation.md)
  - [Adding lore to `ranksgui:`](./Advanced-Configuration-Example/adding-lore-to-ranksgui.md)
    - [In `locale`](./Advanced-Configuration-Example/1-in-the-locale.md)
    - [In `rankups.yml`](./Advanced-Configuration-Example/2-in-the-rankupsyml.md)
  - [Progress Bars](./Advanced-Configuration-Example/progress-bars.md)
    - [Requirements](./Advanced-Configuration-Example/requirements.md)
    - [Important Notes](./Advanced-Configuration-Example/important-notes.md)
    - [Versions](./Advanced-Configuration-Example/versions.md)
    - [Progress Bars With Placeholders](./Advanced-Configuration-Example/progress-bars-with-placeholders.md)
      - [Example](./Advanced-Configuration-Example/example-bars-with-placeholders.md)
    - [Progress Bars With Sub-Requirements](./Advanced-Configuration-Example/progress-bars-with-sub-requirements.md)
      - [Example](./Advanced-Configuration-Example/example-bars-with-sub-requirements.md)
  - [Change Requirement Color When completed](./Advanced-Configuration-Example/change-requirement-chat-color-when-completed.md)
    - [The Placeholder](./Advanced-Configuration-Example/the-important-bit.md)
    - [Installation Process](./Advanced-Configuration-Example/installation-process.md)
    - [Versions](./Advanced-Configuration-Example/versions-1.md)
