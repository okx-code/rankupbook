...
[How to rankups.yml and prestiges.yml](./How-to-rankups.yml-and-prestiges.yml.md)
 - [How to Rankups](https://okx.sh/rankup/How-to-rankups.yml-and-prestiges.yml.html#how-to-rankups)
   - [Optionals](https://okx.sh/rankup/How-to-rankups.yml-and-prestiges.yml.html#optionals)
 - [How to Prestiges](https://okx.sh/rankup/How-to-rankups.yml-and-prestiges.yml.html#how-to-prestiges)
   - [What's Special About Prestiges?](https://okx.sh/rankup/How-to-rankups.yml-and-prestiges.yml.html#whats-special-about-prestiges)
 ---
# Basic Configurations
[Configuration Example](./Configuration-Example.md)
- [Minimum Requirements](./Configuration-Example#minimum-requirements-to-use-rankup)
  - [Steps and Ladders](./Configuration-Example#steps-and-ladders)
- [Your First Rank](./Configuration-Example#your-first-rank)
  - [Starting to Format](./Configuration-Example#starting-to-format)
  - [An Example](./wiki/Configuration-Example#an-example)
  - [Group Management](./wiki/Configuration-Example#group-management)
- [Wrong Message](./wiki/Configuration-Example#wrong-message)
  - [Option 1](./wiki/Configuration-Example#option-1)
  - [Option 2](./wiki/Configuration-Example#option-2)
  - [Post Options](./wiki/Configuration-Example#post-options)
- [Confirmation GUI](./wiki/Configuration-Example#confirmation-gui)
 ---
